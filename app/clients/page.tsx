...
import { checkUserModuleAccess, getAccessRequests } from "@/lib/actions/auth-actions";
...
export default async function ClientsPage(props: {
  ...
  const accessCheck = await checkUserModuleAccess("clients");
  ...
  const accessRequests = isAdmin ? await getAccessRequests() : [];
    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-black font-sans py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="mb-6">
          <Link
            href="/"
            className="text-sm font-medium text-zinc-500 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100 transition-colors inline-flex items-center"
          >
        ...
        {/* Admin Access Request Approval Panel */}
        {isAdmin && <AdminAccessRequestsPanel initialRequests={accessRequests as any} />}
